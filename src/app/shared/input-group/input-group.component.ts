...
export class InputGroupComponent implements OnInit {
  ...
  @Input() prefixaddons2: string;
  @Input() suffixaddons: string;
  @Input() suffixaddons2: string;
  @Input() addons: string;
  ...
  @Input() isWhole = false;
  @Input() viewprefix: boolean = false;
  @Input() viewsuffix: boolean = false;
  @Input() viewmultiprefix: boolean = false;
  @Input() viewmultisuffix: boolean = false;
  @Input() viewaddons: boolean = false;
